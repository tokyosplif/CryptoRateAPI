...
/* Настройка Cron Job для периодического выполнения:
   ...
   **Создание команды Symfony**:
   Для того чтобы метод `updateExchangeRates` выполнялся регулярно, нужно создать команду Symfony,
   которая будет вызываться через Cron. В проекте эта команда не создана.
   Это команда, которую можно будет вызывать через Cron Job для автоматического выполнения.*/
