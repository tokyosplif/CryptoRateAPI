...
/* Создание команды Symfony:
     ...
     для регулярного выполнения задачи. С помощью Cron Job можно настроить выполнение команды на уровне операционной системы,
     а Symfony Scheduler позволяет интегрировать этот процесс прямо в фреймворк Symfony для более гибкого управления задачами.*/